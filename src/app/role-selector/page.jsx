...
const roles = [
  ...
  },
  {
    ...
    title: "Writer",
    description:
      "Create, publish, and manage your ebooks for readers around the world.",
      ...
      <section className="relative w-full max-w-4xl rounded-3xl border border-white/[0.09] bg-bg-card p-7 shadow-[0_25px_80px_rgba(0,0,0,0.45)] sm:p-12">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-sm leading-relaxed text-ink-muted sm:text-base">
            Choose a role to personalize your workspace. You can change it later
          ...
          {roles.map((role) => {
            ...
            return (
              <button
                ...
                className="group rounded-2xl border border-white/[0.09] bg-bg-raised p-7 text-left transition-all hover:-translate-y-1 hover:border-gold/50 hover:shadow-[0_16px_40px_rgba(0,0,0,.28)] disabled:cursor-wait disabled:opacity-70"
              >
                <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-gold-dim text-xl text-gold">
                  <Icon />
                </span>
                ...
                <span className="mt-6 inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-gold">
                  {isSaving ? "Saving…" : "Choose this role"}
