...
export default async function SalesHistoryPage() {
  ...
  return (
    <main className="mx-auto max-w-7xl px-5 pt-22 pb-12 sm:px-8 lg:px-12 lg:pt-12">
      <WriterPageHeader
        title="Sales history"
        subtitle="Every purchase made from your published ebooks."
      />
      <div className="mt-8 overflow-x-auto rounded-2xl border border-white/[.07] bg-bg-card">
        <table className="w-full min-w-180 text-left">
          <thead className="border-b border-white/[.07] text-[.65rem] tracking-[.15em] text-ink-faint uppercase">
            <tr>
              {["Ebook title", "Buyer", "Purchase date", "Amount"].map((x) => (
